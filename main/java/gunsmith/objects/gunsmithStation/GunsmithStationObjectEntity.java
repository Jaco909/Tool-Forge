...
public class GunsmithStationObjectEntity extends ObjectEntity implements OEInventory {
    public Inventory inventory = new Inventory(3);

    public GunsmithStationObjectEntity(Level level, int x, int y) {
        super(level, "gunsmithstation", x, y);
    }
