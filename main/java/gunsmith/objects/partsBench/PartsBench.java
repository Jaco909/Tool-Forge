...
public class PartsBench extends CraftingStationObject {
    ...
    public void loadTextures() {
        super.loadTextures();
        this.texture = ObjectDamagedTextureArray.loadAndApplyOverlay(this,"objects/PartsBench");
    }
    ...
    public CraftingStationUpgrade getStationUpgrade() {
        return new CraftingStationUpgrade(ObjectRegistry.getObject("PartsBenchTier2"), new Ingredient[]{new Ingredient("demonicbar", 10)});
    }
    ...
    public Tech[] getCraftingTechs() {
        return new Tech[]{RecipeTechRegistry.getTech("PARTSBENCH")};
    }
}
