...
public class PartsBenchTier4 extends CraftingStationObject {
    public ObjectDamagedTextureArray texture;

    public PartsBenchTier4() {
    ...
    public void loadTextures() {
        super.loadTextures();
        this.texture = ObjectDamagedTextureArray.loadAndApplyOverlay(this,"objects/PartsBenchTier4");
    }
    ...
    public Tech[] getCraftingTechs() {
        return new Tech[]{RecipeTechRegistry.getTech("PARTSBENCH4"), RecipeTechRegistry.getTech("PARTSBENCH3"), RecipeTechRegistry.getTech("PARTSBENCH2"), RecipeTechRegistry.getTech("PARTSBENCH")};
    }
}