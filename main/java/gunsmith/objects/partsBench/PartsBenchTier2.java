...
public class PartsBenchTier2 extends CraftingStationObject {
    public ObjectDamagedTextureArray texture;

    public PartsBenchTier2() {
    ...
    public void loadTextures() {
        super.loadTextures();
        this.texture = ObjectDamagedTextureArray.loadAndApplyOverlay(this,"objects/PartsBenchTier2");
    }
    ...
    public CraftingStationUpgrade getStationUpgrade() {
        return new CraftingStationUpgrade(ObjectRegistry.getObject("PartsBenchTier3"), new Ingredient[]{new Ingredient("tungstenbar", 8),new Ingredient("obsidian", 5)});
    }
    ...
    public Tech[] getCraftingTechs() {
        return new Tech[]{RecipeTechRegistry.getTech("PARTSBENCH2"), RecipeTechRegistry.getTech("PARTSBENCH")};
    }
}