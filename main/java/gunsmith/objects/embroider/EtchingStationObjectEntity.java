...
public class EtchingStationObjectEntity extends ObjectEntity implements OEInventory {
    public Inventory inventory = new Inventory(1);

    public EtchingStationObjectEntity(Level level, int x, int y) {
        super(level, "etchingstation", x, y);
    }
