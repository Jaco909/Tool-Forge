...
public class BonusPartStation extends CraftingStationObject {
    public ObjectDamagedTextureArray texture;

    public BonusPartStation() {
    ...
    public void loadTextures() {
        super.loadTextures();
        this.texture = ObjectDamagedTextureArray.loadAndApplyOverlay(this,"objects/BonusPartStation");
    }
    ...
    public ListGameTooltips getItemTooltips(InventoryItem item, PlayerMob perspective) {
        ...
        tooltips.add(Localization.translate("itemtooltip", "bonusPartStationTip"), 400);
        return tooltips;
    }
    ...
    public ObjectEntity getNewObjectEntity(Level level, int x, int y) {
        return new BonusPartStationObjectEntity(level, x, y);
    }
}
