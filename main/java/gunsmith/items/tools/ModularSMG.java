...
public class ModularSMG extends ModularGun implements ItemInteractAction {
    public ModularSMG() {
    ...
    public InventoryItem defaultBody(InventoryItem item){
        return ItemRegistry.getItem(item.getGndData().getString("BodyItem","BodyMachinegunBasic")).getDefaultItem(null,1);
    }
    public InventoryItem defaultStock(InventoryItem item){
        return ItemRegistry.getItem(item.getGndData().getString("StockItem","StockMachinegunIron")).getDefaultItem(null,1);
    }
    ...
    public ListGameTooltips getPreEnchantmentTooltips(InventoryItem item, PlayerMob perspective, GameBlackboard blackboard) {
        ...
        if (!item.getGndData().hasKey("StockItem")) {
            ...
            if (partsKey.isDown() && partsKey != statsKey) {
                tooltips.add(Localization.translate("itemtooltip", "Barrel") + " " + Localization.translate("item", item.getGndData().getString("BarrelItem", "BarrelMachinegunIron")+"Name"));
                tooltips.add(Localization.translate("itemtooltip", "Body") + " " + Localization.translate("item", item.getGndData().getString("BodyItem", "BodyMachinegunBasic")+"Name"));
                tooltips.add(Localization.translate("itemtooltip", "Stock") + " " + Localization.translate("item", item.getGndData().getString("StockItem", "StockMachinegunIron")+"Name"));
                ...
                tooltips.add(Localization.translate("barreltooltip", item.getGndData().getString("BarrelItem", "BarrelMachinegunIron")+"Tip"));
                ...
                tooltips.add(Localization.translate("bodytooltip", item.getGndData().getString("BodyItem", "BodyMachinegunBasic")+"Tip"));
                ...
                tooltips.add(Localization.translate("stocktooltip", item.getGndData().getString("StockItem", "StockMachinegunIron")+"Tip"));
            } else {
    ...
    public void drawIcon(InventoryItem item, PlayerMob perspective, int x, int y, int size, Color color) {
        ...
        new GameSprite(GameTexture.fromFile("items/" + item.getGndData().getString("BarrelItem", "BarrelMachinegunIron"))).initDraw().color(color).size(size).draw(x, y);
        new GameSprite(GameTexture.fromFile("items/" + item.getGndData().getString("StockItem", "StockMachinegunIron"))).initDraw().color(color).size(size).draw(x, y);
        new GameSprite(GameTexture.fromFile("items/" + item.getGndData().getString("BodyItem", "BodyMachinegunBasic"))).initDraw().color(color).size(size).depth(-1F).draw(x, y);
        ...
        if (!texture.exists()) {
            GameTexture baseWorld = GameTexture.fromFile("player/weapons/Machinegun/ModularMachinegunBase.png", true);
            GameTexture barrelMatTex = GameTexture.fromFile("player/weapons/Machinegun/"+item.getGndData().getString("BarrelItem", "BarrelMachinegunIron")+".png", true);
            GameTexture bodyMatTex = GameTexture.fromFile("player/weapons/Machinegun/"+item.getGndData().getString("BodyItem", "BodyMachinegunBasic")+".png", true);
            GameTexture stockMatTex = GameTexture.fromFile("player/weapons/Machinegun/"+item.getGndData().getString("StockItem", "StockMachinegunIron")+".png", true);
    ...
    public boolean canLevelInteract(Level level, int x, int y, ItemAttackerMob attackerMob, InventoryItem item) {
        ...
        if (bulletcheck != null && defaultBody(item).getGndData().getString("BodyName","Basic").equalsIgnoreCase("Chaingun") && item.getGndData().getInt("ChargedShots") > 0) {
            return true;
        } else {
            return false;
        }
    ...
    public void setModifier(Projectile projectile, InventoryItem item) {
        if (defaultBody(item).getGndData().getString("BodyName").equalsIgnoreCase("Crystal")) {
